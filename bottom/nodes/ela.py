...
class ElaNode(Node):
    ...
    def __init__(self, config, index: int, node_public_key, cwd_dir: str):
        Node.__init__(self, config)
        self.tag = "[bottom.nodes.ela.MainNode]"
        self.index = index
    ...
    def reset_config(self, num: int, update_content: dict):
        ...
        _config[constant.CONFIG_ARBITER_CONFIGURATION][constant.CONFIG_PUBLIC_KEY] = self.node_public_key
