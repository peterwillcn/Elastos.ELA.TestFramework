...
def list_unspent_utxos(addresses, assetid=None, port=DEFAULT_PORT):
    if assetid is None:
        return post_request("listunspent", params={"addresses": [addresses]}, port=port)
    else:
        return post_request("listunspent", params={"addresses": [addresses], "assetid": assetid}, port=port)
